  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
    <div class="bg-card rounded-lg p-6 w-full max-w-md">
      ...
      <form on:submit|preventDefault={handleSubmit} class="space-y-4">
        <div>
          <label for="txn-date" class="block text-sm font-medium mb-1">Date</label>
          <input 
            id="txn-date"
            type="date" 
        ...
        <div>
          <label for="txn-type" class="block text-sm font-medium mb-1">Type</label>
          <select 
            id="txn-type"
        ...
        <div>
          <label for="txn-category" class="block text-sm font-medium mb-1">Category</label>
          <select 
            id="txn-category"
        ...
        <div>
          <label for="txn-amount" class="block text-sm font-medium mb-1">Amount (IDR)</label>
          <input 
            id="txn-amount"
            type="number" 
        ...
        <div>
          <label for="txn-description" class="block text-sm font-medium mb-1">Description</label>
          <input 
            id="txn-description"
            type="text" 
